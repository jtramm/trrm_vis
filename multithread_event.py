...
ax.axis('off')
ax.set_aspect('equal')
ax.set_ylim(-1.26/2.0-0.1, 1.26/2.0+0.1)
ax.set_xlim(-1.26/2.0-0.1, 1.26/2.0+0.1)
...
ax.add_patch(circ)
circ=plt.Rectangle((-1.26/2,-1.26/2), width=1.26, height=1.26, color='k', fill=False)
ax.add_patch(circ)
...
animation = animation.FuncAnimation( fig, plot_single_path, tot_iters*2 + begin_frames+1, interval = 500 )
#plt.show()
