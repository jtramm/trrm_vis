...
fig, ax = plt.subplots()
#fig.subplots_adjust(left=0.1, bottom=0.1, right=0.1, top=0.1, wspace=None, hspace=None)
#fig.subplots_adjust(left=0.1, bottom=0.1, right=0.11111, top=0.11111, wspace=None, hspace=None)
